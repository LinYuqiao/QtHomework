...
void ServerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->disconnetedFromClient(); break;
        ...
        }
        {
            ...
            if (_t _q_method = &ServerWorker::disconnetedFromClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void ServerWorker::disconnetedFromClient()
{
